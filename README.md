...
a variável *incrementa* serva para  escolher entre o valor que esteja "rodando" dentro do PC ou se escolhe o valor incrementado por um somador.
...
A ULA foi codificada da seguinte maneira:

* 000: Operação de soma entre A e B;
* 001: Operação lógica AND entre A e B;
* 010: Operação lógica OR entre A e B;
* 011: Inversão binária de B;
* 100: Mostra a entrada B.

Ainda, existe uma saída chamada NZ para indicar se o número é positivo ou zero. De forma simplificada, a saída NZ conta com dois bits, dos quais o primeiro representa o caso de o número ser negativo e a segundo o caso do número ser zero. A lista a seguir indica as possibilidades de saída para NZ.
